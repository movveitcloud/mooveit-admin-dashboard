...
const RefundLayout = ({ state, statefunc, stating, func }) => {
  return (
    <div className=" p-4 md:p-16 py-14 text-black flex flex-col justify-center items-center">
      ...
      <div className=" p-4 md:p-16 py-14 md:px-0 text-black flex flex-col justify-center  items-center align-middle w-full ">
        ...
        <p className="text-xl  md:text-2xl mb-6">{state} Payment</p>
        <p className="text-[#959595] text-base md:text-xl  mb-6">Kindly confirm that you are {stating} this payment</p>
        <button className="w-full rounded-md p-4 text-[14px] md:text-base text-white bg-[#4543A5]">REFUND</button>
      </div>
    </div>
  );
};
