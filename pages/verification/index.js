...
import { Customer, DashboardLayout, Resolved } from "../../components";
    ...
    <DashboardLayout>
      <div className="flex space-x-5 mb-4">
        <button
          ...
          className={`${
            activeButton === "customer" ? "bg-accent-focus text-accent-content" : "bg-[#EEEEEE] text-[#BBBBBB] "
          }  py-2 px-4 rounded-md  flex items-center align-middle justify-center text-sm md:text-base `}>
          Customer
          <div
            className={` ${
              activeButton === "customer" ? "bg-accent-content" : "bg-[#BBBBBB]"
        ...
        <button
          ...
          className={`${
            activeButton === "partners" ? "bg-accent-focus text-accent-content" : "bg-[#EEEEEE] text-[#BBBBBB]"
          }  py-2 px-4 rounded-md  flex items-center align-middle justify-center text-sm md:text-base`}>
          Partners
          <div
            className={` ${
      ...
      <div className="bg-white p-8 shadow ">
        ...
        {activeButton === "customer" ? <Customer /> : <Customer />}
      </div>
    </DashboardLayout>
  );
};
