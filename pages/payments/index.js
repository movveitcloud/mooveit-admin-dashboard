  ...
  return (
    <DashboardLayout>
      <div className="flex space-x-5 mb-4">
        ...
        <button
          onClick={() => setActiveButton("refunded")}
          className={`${
            activeButton === "refunded" ? "bg-accent-focus text-accent-content" : "bg-[#EEEEEE] text-[#BBBBBB]"
          }  py-2 px-4 rounded-md  flex items-center align-middle justify-center text-sm md:text-base`}>
          Refunded
          <div
            className={` ${
              activeButton === "refunded" ? "bg-accent-content" : "bg-[#BBBBBB]"
            } ml-2 text-white  text-[10px] rounded-sm  p-2  h-4 flex align-middle items-center`}>
            16.8k
          </div>
        </button>
